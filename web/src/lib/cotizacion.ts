...
const unitSchema = z.object({
  ...
  /* Giro y posición de la puerta. No afectan el precio, pero viajan con el
     proyecto porque el taller los necesita para fabricar. */
  doorSwing: z.enum(['left-in', 'left-out', 'right-in', 'right-out']).nullish(),
  doorPosition: z.enum(['center', 'left', 'right']).nullish(),
